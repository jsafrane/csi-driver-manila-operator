...
require (
	...
	github.com/openshift/library-go v0.0.0-20210315125541-d1d692b5b1ed
...
replace github.com/openshift/library-go v0.0.0-20210315125541-d1d692b5b1ed => ../library-go
